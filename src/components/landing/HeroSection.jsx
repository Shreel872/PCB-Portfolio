  ...
  return (
    <section className="px-6 pt-20 pb-16 max-w-4xl mx-auto">
      <motion.p
        ...
        initial="hidden"
        animate="visible"
        className="text-xs uppercase tracking-[0.25em] text-gray-500 mb-4"
      >
      ...
      <motion.h1
        ...
        initial="hidden"
        animate="visible"
        className="text-4xl sm:text-5xl font-bold text-gray-100 tracking-tight mb-3"
      >
        Shreel Patel
      </motion.h1>
      ...
      <motion.p
        ...
        initial="hidden"
        animate="visible"
        className="text-base sm:text-lg text-gray-400 font-medium mb-6"
      >
        Mechatronics Engineer{" "}
        <span className="text-gray-600 mx-1">|</span> PCB Design{" "}
        <span className="text-gray-600 mx-1">|</span> Automotive Electrical
        Systems
      </motion.p>
